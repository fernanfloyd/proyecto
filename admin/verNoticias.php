...
<html lang="es">
	<head>
		...
		<title>ImpactFilm | Ver Noticias</title>
	</head>
	<body>
		...
		<div class="contenedor margen_contenedor">
			...
			<section>
				...
				<div class="cajaSeleccion" style='background-color: white;'>
					<p><a href="nuevaNoticia.php"><input type='button' class='botonRojo' name='bNuevaNoticia' id='bNuevaNoticia' value='Nueva noticia' /></a></p>
				</div>
				<?php
						...
						foreach($IDS as $j=>$id){
							...
							echo "<div class='cajitasIzq'>";
								...
								echo "<div class='caja_texto'>";
									echo "<p>21-03-2013<span style='float:right;'><a href='borrarNoticia.php?parametro=".$id."' onclick='return deleteNoticiaConfirm()'><img src='../imagenes/delete.png' title='Borrar la noticia ".$noticia['titulo']."' style='width:17px;height:17px;'  /></a><a href='verNoticia.php?parametro=".$id."'><img src='../imagenes/modify.png' title='Modificar la noticia ".$noticia['titulo']."' style='width:15px;height:15px;' /></a></span></p>";
