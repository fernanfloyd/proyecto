		...
		<div class="contenedor margen_contenedor">
			...
			<section>
				...
				<div class='cajaMostrar'>
					<p style='color: red;font-size:13px;'>*Si este actor esta en el reparto de alguna de las películas ya registradas en la base de datos, puedes seleccionarla más abajo, pero no es obligatorio</p>
					<form enctype='multipart/form-data' id='formNuevoActor' name='formNuevoActor' action='insertarActor.php' method='post'>
						<div class='nuevoIzq'>
							<p style='text-align: right;padding-right: 30px;'>
								...
								<b>Películas en las que aparece: </b><br/>
							</p>
						</div>
						<div class='nuevoDer'>
							<p>
							<input type='text' name='tNombreApe' id='tNombreApe' maxlength='50' size='40' required />&nbsp;<br/>
							<input type='file' name='fFotoActor' id='fFotoActor' size='40' required />&nbsp;<br/>
							<input type='text' name='tNacionalidad' id='tNacionalidad' maxlength='30' size='40' required />&nbsp;<br/>
							<input type='text' id='datepicker' name='datepicker' required />&nbsp;<br/>
							<?php
							$todasPeliculas=obtenerNombreIdPeliculas();
							echo "<select name='selPeliculas[]' id='selPeliculas[]' multiple size='8'>";
							while($fila=mysql_fetch_array($todasPeliculas)){
								echo "<option value='".$fila[0]."'>".$fila[1]."</option>";
							}
							echo "</select>&nbsp;<br/>";
							?>
							<textarea name='tAreaCarrera' id='tAreaCarrera' required></textarea>&nbsp;<br/>
							<input type='submit' name='sNuevoActor' id='sNuevoActor' value='Crear actor' class='botonRojo' />
							</p>
						</div>
