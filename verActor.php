...
<html lang="es">
	<head>
		...
		<title>ImpactFilm | Nombre de actor</title>
	</head>
	<body>
			...
			<section>
				...
				if(empty($_GET['parametro'])){
					...
					echo "<div class='cajaDatos'>";
						...
						$mes = $fecha[1];
						$anno = $fecha[0];
						echo "<p><b>Fecha Nacimiento:</b> ".$dia."-".$mes."-".$anno."</p>";
						echo "<p><b>Pais:</b> ".$actor['pais']."</p>";
						echo "<p><b>Carrera:</b> </p>";
						echo "<p>".$actor['carrera']."</p>";
						$peliculas=obtenerPeliculas($id);
						echo "<p><b>Peliculas: </b>";
						foreach($peliculas as $i=>$p){
							$nombre=obtenerNombrePelicula($p);
							echo "<a href='verPelicula.php?parametro=".$p."'>".$nombre."</a><br>";
						}
						echo "</p>";
