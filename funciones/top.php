...
nuevaConexionBd();
						$top=array();
						//$consulta="SELECT PE.TITULO,SUM(VE.CANTIDAD) AS NVENDIDOS,VE.ID_PELICULA FROM VENTAS AS VE LEFT JOIN PELICULAS AS PE ON PE.ID_PELICULA = VE.ID_PELICULA GROUP BY VE.ID_PELICULA ORDER BY NVENDIDOS DESC LIMIT 10;";
